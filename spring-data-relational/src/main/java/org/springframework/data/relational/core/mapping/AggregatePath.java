...
public interface AggregatePath extends Iterable<AggregatePath>, Comparable<AggregatePath> {
	...
	record TableInfo(
		...
		private static ColumnInfos computeIdColumnInfos(AggregatePath tableOwner,
			...
			Map<AggregatePath, ColumnInfo> idColumnInfoMap = new TreeMap<>();
		...
		private static ColumnInfos computeReverseColumnInfo(AggregatePath path) {
			...
			Map<AggregatePath, ColumnInfo> reverseColumnInfos = new TreeMap<>();
	...
	class ColumnInfos {
		...
		public static ColumnInfos fromFullPaths(AggregatePath basePath, Map<AggregatePath, ColumnInfo> columnInfoMap) {
			...
			Map<AggregatePath, ColumnInfo> shortPathColumnInfos = new TreeMap<>();
