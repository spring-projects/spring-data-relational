 ...
 * @since 4.1
 */
enum UpsertRenderContexts implements UpsertRenderContext {
	...
	/**
	 * SQL Server MERGE upsert. The statement body matches {@code UpsertStatementRenderers.Merge} with a trailing
	 * semicolon.
	 */
	SQL_SERVER,
