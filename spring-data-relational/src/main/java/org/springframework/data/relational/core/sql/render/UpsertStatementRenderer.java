...
/**
 * Dialect-specific upsert SQL as single statement operation(e.g. {@code MERGE}, {@code INSERT ... ON CONFLICT},
 * {@code INSERT ... ON DUPLICATE KEY UPDATE}).
 * <p>
 * Callers resolve {@link Column}s and {@link Table} while implementations assemble syntax and use
 * {@link UpsertRenderingContext} to match names and bind markers against the enclosing {@link RenderContext}. Concrete
 * renderers are defined in {@link UpsertStatementRenderers}.
 *
