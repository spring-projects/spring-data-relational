...
public interface DataAccessStrategy extends ReadingDataAccessStrategy, RelationResolver {
	 ...
	 * @param <T> the type of the instance.
	 * @return the id generated by the database if any (typically {@code null} when id is provided).
	 * @throws UnsupportedOperationException if the dialect does not support upsert.
	 * @since 4.x
	 */
	<T> @Nullable Object upsert(T instance, Class<T> domainType, Identifier identifier);
