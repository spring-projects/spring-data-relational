...
To learn more about this please make sure to read the Spring Boot https://docs.spring.io/spring-boot/reference/data/sql.html#data.sql.jdbc[Reference Documentation].
====
