...
When the statement is run, an instance of javadoc:org.springframework.data.jdbc.mybatis.MyBatisContext[] gets passed as an argument, which makes various arguments available to the statement.
