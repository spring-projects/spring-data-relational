...
class PartTreeR2dbcQueryUnitTests {
	...
	private static final String[] ALL_FIELDS_ARRAY = new String[] { ".\"id\"", ".\"first_name\"", ".\"last_name\"",
			".\"date_of_birth\"", ".\"age\"", ".\"active\"" };
	...
	void createsQueryToFindByOpenProjection() throws Exception {
		...
		PreparedOperationAssert.assertThat(preparedOperation) //
				.selects("\"users\".\"id\"", "\"users\".\"first_name\"", "\"users\".\"last_name\"",
						"\"users\".\"date_of_birth\"", "\"users\".\"age\"", "\"users\".\"active\"") //
				.from(TABLE);
	}
